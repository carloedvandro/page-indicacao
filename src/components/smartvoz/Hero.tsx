    ...
    <header className="waves-bg overflow-hidden px-3 pb-8 pt-6 sm:px-6 sm:pb-10 lg:pb-12">
      ...
      <div className="mx-auto mt-4 grid max-w-screen-2xl items-center gap-10 sm:mt-8 lg:mt-8 lg:grid-cols-2 lg:items-start lg:gap-14">
        <div className="rise-in">
          ...
          <h1 className="mt-6 text-balance text-[1.85rem] font-extrabold leading-[1.08] text-ink sm:text-[2.45rem] lg:mt-5 lg:text-[3.25rem]">
            Todo mundo que você
            <br className="lg:hidden" /> conhece já paga internet
            <br className="lg:hidden" /> todos os meses.
          </h1>
