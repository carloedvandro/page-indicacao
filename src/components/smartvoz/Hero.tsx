  ...
  return (
    <header className="waves-bg overflow-hidden px-3 pb-8 pt-6 sm:px-6 sm:pb-10 lg:pb-12">
      <div className="mx-auto flex max-w-7xl items-center justify-center px-4">
        <Logo className="h-[4.5rem] sm:h-28 lg:h-32" />
      </div>

      <div className="mx-auto mt-10 grid max-w-7xl items-center gap-10 lg:mt-16 lg:grid-cols-2 lg:gap-14">
        <div className="rise-in">
          <p className="w-full text-center font-display text-[0.85rem] font-extrabold uppercase leading-tight tracking-[0.1em] text-ink sm:text-[1.05rem] sm:tracking-[0.12em] lg:text-left">
      ...
      <div className="mx-auto mt-10 flex max-w-7xl justify-center mb-10 sm:mt-12 sm:mb-12 lg:mt-14 lg:mb-14">
        <button
          type="button"
          onClick={abrirPlayer}
