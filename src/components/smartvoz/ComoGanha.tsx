...
const niveis = [
  {
    nivel: "NÍVEL 1",
    descricao: "Suas indicações diretas",
    valor: "R$ 50,00\n+ R$ 20,00/mês",
  },
  ...
  return (
    <section className="waves-bg px-3 pb-6 pt-2 sm:px-6 lg:pb-10 lg:pt-4">
      <div className="mx-auto max-w-screen-2xl">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-[1.15fr_1fr] lg:gap-8">
          {/* coluna esquerda: adesão + recorrência + faixa infinito */}
          <div className="flex flex-col gap-5">
            <div className="relative grid flex-1 items-stretch gap-5 sm:grid-cols-2 sm:gap-6">
              <article className="surface-card flex h-full flex-col items-center justify-between p-6 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <p className="mt-5 whitespace-nowrap font-display text-[2.6rem] font-extrabold tracking-tight text-primary lg:text-[3rem]">
                    R$ 50,00
                  </p>
                </div>
              ...
              <article className="surface-card flex h-full flex-col items-center justify-between p-6 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <p className="mt-5 whitespace-nowrap font-display text-[2.6rem] font-extrabold tracking-tight text-primary lg:text-[3rem]">
                    R$ 20,00
                    <span className="align-baseline text-xl font-bold">
                      /mês
                    </span>
                  </p>
                </div>
            ...
            {/* faixa infinito */}
            <div className="surface-card flex items-center gap-4 p-4 sm:px-6">
          ...
          <article className="surface-card p-5 sm:p-6">
            ...
            <div className="relative mt-5">
              <span
                aria-hidden="true"
                className="absolute bottom-4 left-[4.1rem] top-0 hidden w-px border-l border-dashed border-primary/30 sm:block"
              />
              <ul className="relative space-y-2.5">
                {niveis.map((n) => (
                  <li
                    key={n.nivel}
                    className="grid grid-cols-[4.5rem_1.5rem_minmax(0,1fr)_auto] items-center gap-2.5 rounded-xl border border-border px-3 py-2.5"
                  >
        ...
        {/* faixa final: comissões transparentes */}
        <div className="surface-card mt-5 flex flex-col items-center gap-4 p-5 text-center sm:flex-row sm:gap-6 sm:px-8 sm:text-left">
          <span className="flex size-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-primary shadow-glow">
            <ShieldCheck
